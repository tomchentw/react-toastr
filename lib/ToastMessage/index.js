...
var animation = exports.animation = createReactClass((0, _reactAddonsUpdate2.default)(ToastMessageSpec, {
  displayName: { $set: "ToastMessage.animation" },
  mixins: { $set: [_animationMixin2.default] }
}));

var jQuery = exports.jQuery = createReactClass((0, _reactAddonsUpdate2.default)(ToastMessageSpec, {
