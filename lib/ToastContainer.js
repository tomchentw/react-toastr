...
ToastContainer.propTypes = {
  toastType: _propTypes.PropTypes.shape({
    error: _propTypes.PropTypes.string,
    info: _propTypes.PropTypes.string,
    success: _propTypes.PropTypes.string,
    warning: _propTypes.PropTypes.string
  }).isRequired,
  id: _propTypes.PropTypes.string.isRequired,
  toastMessageFactory: _propTypes.PropTypes.func.isRequired,
  preventDuplicates: _propTypes.PropTypes.bool.isRequired,
  newestOnTop: _propTypes.PropTypes.bool.isRequired,
